...
export const projects: ProjectItem[] = [
  ...
  },
  {
    id: 'jnpf-event',
    title: '城市事件中心 · GIS 大屏',
    subtitle: '网格治理 · Mars3D · DataV',
    description: '事件全生命周期 + 地图模式 + 态势大屏，支持分派/催办/挂起与外部接入。',
    tags: ['Vue3', 'Mars3D', 'Cesium', 'ECharts', 'DataV'],
    device: 'windows',
    accent: '#06b6d4',
    path: 'jnpf/jnpf-qianduan/jnpf-web-datascreen-vue3-v6x',
    highlights: ['地图模式', '外部事件接入', 'DataV 大屏'],
    demo: {
      kind: 'react',
      reactId: 'jnpf-event',
      frame: 'desktop',
      hint: '态势可下钻；地图钉点可分派；工单可催办/挂起并填写处理意见；统计可切维度',
      scenes: [
      ...
      architecture: [
        { name: '大屏', nodes: ['DataV', 'Mars3D', 'MQTT'] },
        { name: '业务', nodes: ['ev_map_mode', 'dashboard'] },
        { name: '后端', nodes: ['jnpf-eventcenter', 'ExternalEvent'] },
      ],
      capabilities: ['态势下钻', '地图分派', '催办挂起', '处理意见', '维度统计'],
    },
    preview: {
      urlBar: '事件中心 / 一图统览',
      sidebar: ['态势', '地图', '工单', '统计'],
      content: [
        { type: 'stats', items: ['今日 86', '办结 61', '催办 7'] },
        { type: 'map', label: '网格热力' },
      ],
    },
  },
